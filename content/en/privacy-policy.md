...
- **Country** refers to: California, U.S.A.
...
- **Functionality Cookies**
  - **Type**: Persistent Cookies
  - **Administered by**: Us
  - **Purpose**: These Cookies allow us to remember choices you make when you use the Website, for example, remembering your login details or language preference. The purpose of these Cookies is to provide you with a more personal experience and to avoid you having to re-enter your preferences every time you use the Website.
...
#### Law enforcement
The Company may be required to disclose your Personal Data in certain circumstances, such as if required to do so by law or in response to valid requests by public authorities (e.g., a court or a government agency).
